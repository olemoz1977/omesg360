...
const resultHtml=`  <section id="result" class="screen result">
    ...
    <div class="resultWorld">
      <div class="resultScene">
        <button id="shipCard" class="sceneZone shipZone" type="button" aria-controls="attentionDetail" aria-expanded="false">
          <span id="firstLabel" class="sceneEyebrow">Pirmas žvilgsnis</span>
          <span id="firstHeading" class="hidden">Kas iškilo?</span>
          <span class="shipStage" aria-hidden="true">
            <span class="shipGhost">
            ...
            <span id="shipTap" class="shipHint"></span>
          </span>
        </button>

        <div class="waterBand" aria-hidden="true"><span class="waterlineLabel">Vaterlinija</span></div>

        <button id="mapCard" class="sceneZone mapZone" type="button" aria-controls="suffDetail" aria-expanded="false">
          <span class="mapTop">
          ...
          <span id="mapTap" class="mapHint"></span>
        </button>
      </div>
