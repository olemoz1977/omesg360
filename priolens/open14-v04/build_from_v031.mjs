...
const clarifierCss=`
.trialhead{height:auto;min-height:62px;align-items:flex-start;gap:12px;padding:2px 0 7px}.trialhead>div:first-child{min-width:0;flex:1}.trialhead .count{flex:0 0 auto;padding-top:2px}.q{line-height:1.18}.rankHint{line-height:1.3}.progress{flex:0 0 3px;margin-top:2px}.stage{grid-template-columns:repeat(2,minmax(0,1fr))}.stim{grid-column:1/-1}.none{grid-column:1/-1}#undoMost{grid-column:1;font-size:13px;padding:8px 10px;white-space:nowrap}#tieLeast{grid-column:2;font-size:13px;padding:8px 10px;white-space:nowrap}.rankAssist{font-weight:600}
