...
const resultHtml=`  <section id="result" class="screen result">
    ...
    <div class="resultWorld">
      ...
      <div id="suffDetail" class="worldDetail detailPagePanel hidden">
        <button id="suffBack" class="detailBack" type="button">← Grįžti į rezultatą</button>
...
if(!html.includes('id="shipDetailsButton"')||!html.includes('id="mapDetailsButton"')||!html.includes('id="attentionBack"')||!html.includes('id="suffBack"'))throw new Error('dedicated result detail navigation missing');
