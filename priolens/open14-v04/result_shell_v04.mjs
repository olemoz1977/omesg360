...
.mapZone{min-height:320px;padding:20px 16px 18px;background:#f6f3eb}.mapTop{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:8px}.mapRouteSummary{max-width:70%;font-size:17px;font-weight:830;line-height:1.14;letter-spacing:-.02em;text-align:right}.mapStage{position:relative;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;min-height:220px;isolation:isolate}.mapStage.routeLands1{grid-template-columns:minmax(0,1fr);max-width:280px;margin:4px auto 0;align-items:start}.mapStage.routeLands2{grid-template-columns:repeat(2,minmax(0,1fr));max-width:500px;margin:6px auto 0;align-items:start}.mapStage.routeLandsMany{grid-template-columns:repeat(2,minmax(0,1fr));margin-top:6px;align-items:start}.mapStage.routeLands0{display:flex;align-items:center;justify-content:center;min-height:180px}.mapEmpty{max-width:250px;text-align:center;font-size:14px;line-height:1.45;color:#77726a}.mapRoutes{position:absolute;inset:0;width:100%;height:100%;z-index:2;pointer-events:none;overflow:visible}.routePath{fill:none;stroke:#8c887e;stroke-width:1.55;stroke-dasharray:2.5 6;stroke-linecap:round;opacity:.82}.routeOrigin{fill:#f6f3eb;stroke:#8c887e;stroke-width:1.45}.continent{position:relative;z-index:1;min-height:140px;border:1px solid #d2ccbf;border-radius:58% 42% 54% 46% / 46% 55% 45% 54%;background:rgba(251,250,246,.94);padding:20px 14px 16px;display:flex;flex-direction:column;justify-content:center;gap:8px;text-align:center;box-shadow:0 7px 18px rgba(55,48,37,.035)}.continent:nth-child(2n){border-radius:43% 57% 47% 53% / 55% 43% 57% 45%}.routeLands1 .continent{min-height:152px}.routeLands2 .continent,.routeLandsMany .continent{min-height:126px}.continentTitle,.needNode{position:relative;z-index:3}.continentTitle{font-size:9px;font-weight:840;line-height:1.2;letter-spacing:.07em;text-transform:uppercase;color:#8a8479}.needNode{font-size:10.5px;line-height:1.2;color:#4d4a45}.needNode.routeTarget{font-weight:850;color:#181818;text-decoration-line:underline;text-decoration-style:dotted;text-decoration-thickness:2px;text-underline-offset:3px}.needNode.routeTarget:before{content:"● ";font-size:8px}.mapHint{font-size:11px;color:#77726a;margin-top:8px;text-align:right}.routeKey{display:none}
