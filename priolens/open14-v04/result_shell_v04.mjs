...
@media(max-width:420px){.resultScene{min-height:714px}.shipZone{height:284px}.shipStage{height:204px}.shipVisual{width:min(96%,360px);height:170px}.shipFocus{left:53%;top:58px;width:39%;font-size:clamp(17px,5vw,22px)}.waterBand{height:58px}.mapZone{min-height:372px}.mapStage{gap:9px;min-height:270px}.routeLands1{width:min(74vw,270px)}.routeLands1 .continent{min-height:214px}.routeLands2 .continent,.routeLandsMany .continent{min-height:132px;padding:16px 8px}.continentTitle{font-size:8px}.needNode{font-size:9.5px}.routeLands1 .continent:not(.multiTargets) .continentTitle{left:30%;top:39%;width:44%}.routeLands1 .continent:not(.multiTargets) .needNode{left:56%;top:59%;max-width:47%}}
