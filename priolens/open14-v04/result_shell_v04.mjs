...
.mapZone{min-height:320px;padding:20px 16px 18px;background:#f3efe5}.mapTop{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:8px}.mapRouteSummary{max-width:70%;font-size:17px;font-weight:830;line-height:1.14;letter-spacing:-.02em;text-align:right}.mapStage{position:relative;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;min-height:220px;isolation:isolate;overflow:hidden}.mapStage.routeLands1{grid-template-columns:minmax(0,1fr);max-width:300px;margin:4px auto 0;align-items:start}.mapStage.routeLands2{grid-template-columns:repeat(2,minmax(0,1fr));max-width:520px;margin:6px auto 0;align-items:start}.mapStage.routeLandsMany{grid-template-columns:repeat(2,minmax(0,1fr));margin-top:6px;align-items:start}.mapStage.routeLands0{display:flex;align-items:center;justify-content:center;min-height:180px}.mapEmpty{max-width:250px;text-align:center;font-size:14px;line-height:1.45;color:#77726a}.mapRoutes{position:absolute;inset:0;width:100%;height:100%;z-index:2;pointer-events:none;overflow:hidden}.routePath{fill:none;stroke:#817b70;stroke-width:1.45;stroke-dasharray:2.3 6.2;stroke-linecap:round;opacity:.72}.continent{position:relative;z-index:1;min-height:142px;padding:24px 20px 20px;display:flex;flex-direction:column;justify-content:center;gap:7px;text-align:center;overflow:visible}.routeLands1 .continent{min-height:156px}.routeLands2 .continent,.routeLandsMany .continent{min-height:128px;padding:19px 12px 17px}.landShape{position:absolute;inset:0;width:100%;height:100%;z-index:0;overflow:visible;filter:drop-shadow(0 5px 8px rgba(55,48,37,.04))}.landFill{fill:#e9e2d3;stroke:#bdb6a8;stroke-width:1.3;vector-effect:non-scaling-stroke}.landCoastDetail{fill:none;stroke:#c8c0b1;stroke-width:.8;opacity:.55;vector-effect:non-scaling-stroke}.continentTitle,.needNode{position:relative;z-index:3}.continentTitle{font-size:9px;font-weight:840;line-height:1.2;letter-spacing:.08em;text-transform:uppercase;color:#777164}.needNode{font-size:10.5px;line-height:1.22;color:#4d4a45}.needNode.routeTarget{display:inline-block;align-self:center;font-weight:850;color:#181818;background:rgba(249,247,240,.72);padding:2px 5px;border-radius:5px;text-decoration:none}.needNode.routeTarget:before{content:"● ";font-size:8px;color:#4f4a42}.mapHint{font-size:11px;color:#77726a;margin-top:8px;text-align:right}.routeKey{display:none}
...
@media(max-width:420px){.resultScene{min-height:648px}.shipZone{height:276px}.shipStage{height:200px}.shipVisual{width:min(96%,360px);height:170px}.shipFocus{left:53%;top:58px;width:39%;font-size:clamp(17px,5vw,22px)}.waterBand{height:58px}.mapZone{min-height:314px}.mapStage{gap:9px;min-height:214px}.routeLands1{width:min(86vw,300px)}.routeLands1 .continent{min-height:154px}.routeLands2 .continent,.routeLandsMany .continent{min-height:122px;padding:17px 9px}.continentTitle{font-size:8px}.needNode{font-size:9.5px}}
