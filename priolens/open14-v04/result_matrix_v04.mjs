...
const COPY={
  lt:{
    ...
    relationNote:'Oranžinė spalva rodo tavo 3 ar mažesnį pakankamumo įvertį. Žalia rodo, kiek kartų pasikartojo išskirta pirmo žvilgsnio kryptis. Spalvų intensyvumas nerodo srities svarbumo. Abi perspektyvos lieka atskiros.'
  },
  en:{
    ...
    relationNote:'Orange shows areas you rated 3 or lower. Green shows how often the selected first-glance direction repeated. Color intensity does not indicate importance. The two perspectives remain separate.'
  }
};
...
function buildMatrixCanvas(model,lang,familyLabels){
  ...
  for(let r=1;r<=12;r++)for(let col=1;col<=12;col++){
    ...
    const lowBand=(lowIndexes.has(r)||lowIndexes.has(col))?' lowBandCell':'';
    const routeCell=(r===col&&routeIndexes.has(r))?' routeCell':'';
    html+='<div class="matrixDataCell'+mirror+diagonal+bridge+lowBand+routeCell+'" style="grid-column:'+(col+1)+';grid-row:'+(r+2)+'">';
...
'@media print{@page{size:A4 landscape;margin:8mm}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}body.priolensPrintMatrix{background:#fff!important}body.priolensPrintMatrix .top,body.priolensPrintMatrix .screen:not(#matrixResult){display:none!important}body.priolensPrintMatrix .wrap{width:100%!important;max-width:none!important;padding:0!important}body.priolensPrintMatrix #matrixResult{display:block!important;width:100%!important;margin:0!important;transform:none!important;padding:0!important}body.priolensPrintMatrix .matrixResult h1{font-size:24px!important;margin-bottom:5px!important}body.priolensPrintMatrix .matrixEyebrow{font-size:8px!important;margin-bottom:3px!important}body.priolensPrintMatrix .matrixLead{font-size:8.5px!important;margin-bottom:7px!important}body.priolensPrintMatrix .matrixSummary{grid-template-columns:repeat(2,1fr)!important;gap:6px!important;margin:6px 0 8px!important}body.priolensPrintMatrix .matrixSummaryCard{padding:6px 8px!important;min-height:42px!important}.matrixSummaryLabel{font-size:6.5px!important}.matrixSummaryValue{font-size:8px!important}body.priolensPrintMatrix .matrixHeadRow{margin:2px 0 4px!important}.matrixHeadRow h2{font-size:12px!important}.matrixHeadRow p{display:none!important}body.priolensPrintMatrix .matrixViewport{overflow:visible!important;border:0!important;box-shadow:none!important}body.priolensPrintMatrix .matrixCanvas{width:100%!important;min-width:0!important;grid-template-columns:32px repeat(12,minmax(0,1fr))!important;grid-template-rows:22px 18px repeat(12,31px)!important}body.priolensPrintMatrix .matrixGroupHeader{font-size:6px!important;padding:2px!important}body.priolensPrintMatrix .matrixTopStatement{font-size:6px!important;padding:2px!important;display:flex!important;align-items:center!important;justify-content:center!important}body.priolensPrintMatrix .matrixTopStatement span{display:none!important}body.priolensPrintMatrix .matrixTopStatement b{font-size:7px!important;margin:0!important}body.priolensPrintMatrix .matrixLeftStatement{position:relative!important;left:auto!important;display:flex!important;align-items:center!important;justify-content:center!important;padding:2px!important;box-shadow:none!important}body.priolensPrintMatrix .matrixLeftStatement span{display:none!important}body.priolensPrintMatrix .matrixLeftStatement b{font-size:7px!important}body.priolensPrintMatrix .matrixFamily{font-size:5.2px!important;padding:2px 3px!important;max-width:62px!important}.matrixNoDirect{font-size:4.8px!important;padding:1px!important}.matrixFamilyStack{inset:2px!important;gap:1px!important}body.priolensPrintMatrix .matrixBridgeNote{font-size:6.5px!important;margin-top:4px!important}body.priolensPrintMatrix .matrixLegend{font-size:6.5px!important;margin:5px 0 3px!important;padding:4px!important;gap:8px!important}body.priolensPrintMatrix .matrixLegendSwatch{width:10px!important;height:7px!important;border-width:1px!important}body.priolensPrintMatrix .matrixRelationNote{font-size:6.5px!important;margin-top:3px!important}body.priolensPrintMatrix .matrixDetailActions,body.priolensPrintMatrix .matrixActions{display:none!important}body.priolensPrintMatrix .matrixPrintAppendix{display:block!important;break-before:page;page-break-before:always;padding-top:2mm}body.priolensPrintMatrix .matrixPrintAppendix h2{font-size:17px!important;margin:0 0 7mm!important}body.priolensPrintMatrix .matrixPrintStatementList{display:grid;grid-template-columns:1fr 1fr;column-gap:12mm;row-gap:4mm}body.priolensPrintMatrix .matrixPrintStatement{display:grid;grid-template-columns:8mm 1fr;gap:2mm;break-inside:avoid;font-size:10px;line-height:1.35;color:var(--mx-ink)}body.priolensPrintMatrix .matrixPrintStatement b{font-size:11px}body.priolensPrintMatrix .matrixPrintLeast{margin-top:9mm;padding-top:5mm;border-top:1px solid var(--mx-line);font-size:9px;line-height:1.45;color:var(--mx-soft)}}'
].join('\n');