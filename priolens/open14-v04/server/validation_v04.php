...
function validate_v04_payload(array $body, bool $isProgress): void {
    ...
    v04_assert(in_array(($body['bankSchema'] ?? null), ['2rasi.priolens.open14.bank-v0.3.1','2rasi.priolens.open14.bank-v0.4'], true), 'v0.4 requires bank-v0.3.1 or bank-v0.4');
